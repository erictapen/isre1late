  ...
  internal = rec {
    ...
    crates = {
      ...
      "figment" = rec {
        ...
        version = "0.10.11";
        edition = "2018";
        sha256 = "07qqgam7d565rw4n7jz4barq7c61n5ij9zrv7b8hm9vmb69sq550";
        authors = [
          "Sergio Benitez <sb@sergio.bz>"
        ];
        dependencies = [
      ...
      "linux-raw-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "elf" "errno" "general" "if_ether" "ioctl" "net" "netlink" "no_std" ];
      };
      "lock_api" = rec {
        crateName = "lock_api";
        version = "0.4.11";
      ...
      "portable-atomic" = rec {
        ...
        version = "1.5.0";
        edition = "2018";
        sha256 = "08s08xzh4i6knhsil2sb9ijcr6advb1b16lm7cnysca91f78jndm";
        features = {
      ...
      "toml 0.8.4" = rec {
        ...
        version = "0.8.4";
        edition = "2021";
        sha256 = "1ijwm6x93rd92xz3ra8825jn7n2kq4kkjya0l3s2vzc52645vxrf";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "toml_edit 0.20.4" = rec {
        crateName = "toml_edit";
        version = "0.20.4";
        edition = "2021";
        sha256 = "1i1gyd076isy48wswzhccxmcwppg2fkn065dr7vp2m20420rw3rq";
        authors = [
          "Andronik Ordian <write@reusable.software>"
          "Ed Page <eopage@gmail.com>"
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "winbase" "winerror" "winnt" "ws2ipdef" "ws2tcpip" ];
      };
