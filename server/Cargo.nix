  ...
  internal = rec {
    ...
    crates = {
      ...
      "diesel" = rec {
        ...
        version = "2.1.6";
        edition = "2021";
        sha256 = "1ckb081mwjig2r3dbf59cf70wmp9j853a2wz15r9a1m5p766l8zz";
        dependencies = [
          {
            name = "bitflags";
            packageId = "bitflags 2.5.0";
      ...
      "diesel_derives" = rec {
        ...
        version = "2.1.4";
        edition = "2021";
        sha256 = "0v46lsf9ggg74jnqh114kqkhjihyxvxdyfqhqysigndysri10w0l";
        procMacro = true;
        dependencies = [
          {
      ...
      "proc-macro2" = rec {
        ...
        version = "1.0.83";
        edition = "2021";
        sha256 = "0hwzkqwnam5b2fsh6nsszc20jbwx9z8klnz5m5ic7pi7qdbfncqb";
        libName = "proc_macro2";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
          "Alex Crichton <alex@alexcrichton.com>"
      ...
      "syn" = rec {
        ...
        version = "2.0.65";
        edition = "2021";
        sha256 = "01niz993nl8gvqfmvi9chg465iayjgggjf3s3mq3jr2cm2b3v1nj";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "toml 0.8.13" = rec {
        ...
        version = "0.8.13";
        edition = "2021";
        sha256 = "1flbvj1c72avfslifz0160n5vxkyw5krrqhshm671janqj63zr54";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
      ...
      "toml_edit 0.22.13" = rec {
        crateName = "toml_edit";
        version = "0.22.13";
        edition = "2021";
        sha256 = "0v5rkld3cl628dygbngr1gk1cxm4pxmawclpshv0ihp8a1c7h9y1";
        authors = [
          "Andronik Ordian <write@reusable.software>"
          "Ed Page <eopage@gmail.com>"
        ];
