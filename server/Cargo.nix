  ...
  internal = rec {
    ...
    crates = {
      ...
      "is-terminal" = rec {
        ...
        version = "0.4.6";
        edition = "2018";
        sha256 = "1n14ql1fpx4d5i6b2r9rs1bbpwg114q0d4fb7blifcdb97vifq15";
        authors = [
      ...
      "syn 1.0.109" = rec {
        ...
        resolvedDefaultFeatures = [ "clone-impls" "extra-traits" "full" "parsing" "printing" "proc-macro" "quote" "visit" "visit-mut" ];
      };
      "syn 2.0.13" = rec {
        crateName = "syn";
        version = "2.0.13";
